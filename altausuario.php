    ...
    <div class="w3-row w3-padding-64">
       ...
       <div align="center" >
        ...
        <a href="verusuarios.php"> <button class="btn warning">Eliminar</button></a>
          ...
          <div align="center">
            <form action="au2.php" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin" style="width:60%;height:40%">
                ...
                <div class="w3-row w3-section">
                 ...
                 <div class="w3-row w3-section">
                  <div class="w3-col" style="width:50px"><i class="fa fa-institution" style="font-size:48px;"></i></div>
                    <div class="w3-rest">
                      <input class="w3-input w3-border" name="plant" type="text" placeholder="Plant">
                    </div>
                </div>
